...
<div class="container mx-auto">
    <h1 class="text-2xl font-semibold mb-4">Add New Product In</h1>

    <form action="{{ route('products_in.store') }}" method="POST">
        @csrf
        <div class="mb-4">
        ...
        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Add Product In</button>
    </form>
</div>
@endsection
